...
<body>
    <div class="wrap">
        ...
        <button type="button" onclick="location.href='/practice'" id="btn-back">이전으로</button>
        <button type="button" onclick="location.href='<%= request.getContextPath() %>'" id="btn-back">이전으로2</button>
        
        <button type="button" onclick="history.back();" id="btn-back2">이전으로3</button>
    </div>
</body>
</html>