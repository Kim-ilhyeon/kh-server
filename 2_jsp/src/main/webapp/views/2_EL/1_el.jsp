...
<%--
	...
	<%
		// request scope 의 데이터를 가져오기
		String classRoom = (String)request.getAttribute("classRoom");
		Student me = (Student)request.getAttribute("student");
		
		// session scope 의 데이터를 가져오기
		String academy = (String)session.getAttribute("academy");
		Student mate = (Student)session.getAttribute("student2");
...
--%>
	...
	<h3>
		EL을 사용하여 보다 쉽게 각 scope영역의 데이터를 화면에 출력
	</h3>
	<p>
		EL을 이용하명 getXXX() 메소드를 사용하지 않고 키값만 제시하여 바로 접근 가능 <br>
	...
	<h3>동일한 키 값으로 저장된 데이터 확인</h3>
	- scope 값 : ${ scope }
	<!-- 
		EL에서는 동일한 키 값으로 저장된 데이터가 있을 경우
